...
extension UIView {
    ...
    func fold(withTransparency: Bool, completionHandler:(()->Void)?, inDirection: FoldDirection ) {
        ...
        bottomTranslationAnimation.fillMode = .forwards
        ...
        case .open:
            ...
            bottomTranslationAnimation.timingFunction = CAMediaTimingFunction(name: .easeOut)
            break;
        case .closed:
            ...
            bottomTranslationAnimation.timingFunction = CAMediaTimingFunction(name: .easeIn)
        }
